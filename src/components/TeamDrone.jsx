...
const people = [
  {
    name: 'Dobril Milchev',
    role: 'Programming, Statistics, Geofencing, Field Tester',
    imageUrl:
  ...
  {
    name: 'Patrik Csabina',
    role: 'Designing, UAV Testing, Website Building, Problem Solving, Field Tester',
    imageUrl:
      'https://static.vecteezy.com/system/resources/previews/007/296/447/non_2x/user-icon-in-flat-style-person-icon-client-symbol-vector.jpg',
    xUrl: '#',
    linkedinUrl: '#',
  ...
  {
    name: 'Roberto Georgiannis',
    role: 'Outreach Program, Safety, Planning',
    imageUrl:
      'https://static.vecteezy.com/system/resources/previews/007/296/447/non_2x/user-icon-in-flat-style-person-icon-client-symbol-vector.jpg',
    xUrl: '#',
    linkedinUrl: '#',
  ...
  {
    name: 'Thomas Gerkema',
    role: 'Budgeting, Deadlines, Documentation, Designing, Field Tester',
    imageUrl:
      'https://static.vecteezy.com/system/resources/previews/007/296/447/non_2x/user-icon-in-flat-style-person-icon-client-symbol-vector.jpg',
    xUrl: '#',
    linkedinUrl: '#',
    ...
    <div className="bg-gray-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-2xl">
          <h2 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl">Dutchman Dynamics</h2>
          <p className="mt-6 text-lg text-gray-400">Four students from Kaj Munk College in Hoofddorp</p>
        </div>
