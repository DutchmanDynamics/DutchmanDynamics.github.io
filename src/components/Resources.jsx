      ...
      <div className="bg-gray-900 py-16 pt-40">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-base sm:text-lg text-gray-400 max-w-xl mx-auto">
            At the moment we don't have any big sponsors. A few people have donated using the QR code below, so you
            could be our first! The biggest sponsor will get its name etched on the bottom of the two CanSats, and will
